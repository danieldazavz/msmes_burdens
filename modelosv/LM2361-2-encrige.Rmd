...
#encrige20 <- read.dbf("algunnombre.dbf")
...
encrige20x1f <- encrige20x1f[1:(nrow(encrige20x1f)-2), ]
...
Eliminación de outliers por sector y tamaño a través del IQR, x2f
...
## 3.2 Estadística descriptiva por tamaño 
...
# Comprobación de la homogeneidad de las varianzas con un gráfico de residuos vs valores ajustados
plot(anova_4$fitted.values, anova_3$residuals, 
     xlab="Valores ajustados", 
     ylab="Residuos",
     main="Gráfico de residuos vs valores ajustados")
abline(h = 0, lty = 2)  # Agrega una línea horizontal en y = 0
...
write.xlsx(ca_e, "C:/Users/danie/OneDrive - CIDE/4to Semestre/Tesina/modelo/datos/ca_e.xlsx")
```
